...
st.subheader('Barchart Representing Gender Percentages Across Lebanese Towns (using options)')

st.plotly_chart(fig)

st.subheader('Barchart Representing Gender Percentages Across Lebanese Towns (using st.bar_chart)')
...
st.subheader('Line Chart Representing Different Family Sizes Lebanese Towns')
...
st.subheader('Area Chart Representing Comparison of Elderly and Youth Percentages Across Towns')
